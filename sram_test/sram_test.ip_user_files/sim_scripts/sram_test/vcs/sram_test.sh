...
compile()
{
  ...
  vhdlan -work axi_apb_bridge_v3_0_18 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sram_test xil_defaultlib.glbl -o sram_test_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sram_test_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key sram_test_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sram_test_simv.daidir vcs_lib c.obj)
