...
#
# Script generated by Vivado on Wed Sep 17 13:12:04 +0800 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : sram_test.sh
...
#
# Usage        : sram_test.sh
#                sram_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sram_test.sh [-reset_run]
#                sram_test.sh [-reset_log]
#                sram_test.sh [-help]
#
...
#                script (type 'sram_test.sh -help' for more information).
#
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sram_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../sram_test.gen/sources_1/bd/sram_test/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../sram_test.gen/sources_1/bd/sram_test/ipshared/aed8/hdl" +incdir+"../../../../sram_test.gen/sources_1/bd/sram_test/ipshared/ec67/hdl" +incdir+"../../../../sram_test.gen/sources_1/bd/sram_test/ipshared/aed8/hdl" +incdir+"D:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvhdl -work axi_apb_bridge_v3_0_18 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.sram_test xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.sram_test -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sram_test_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sram_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sram_test.sh [-help]\n\
Usage: sram_test.sh [-step]\n\
Usage: sram_test.sh [-lib_map_path]\n\
Usage: sram_test.sh [-reset_run]\n\
Usage: sram_test.sh [-reset_log]\n\
Usage: sram_test.sh [-keep_index]\n\
Usage: sram_test.sh [-noclean_files]\n\n\
