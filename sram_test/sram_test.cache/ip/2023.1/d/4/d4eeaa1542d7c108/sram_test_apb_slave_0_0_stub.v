...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(resetn, clk, s_apb_paddr_0, s_apb_penable_0, 
  ...
  s_apb_pwrite_1, s_apb_prdata_1, s_apb_pready_1, s_apb_pslverr_1, clk_sg, m_data_s2d_0, 
  err_sys_hit_0, err_counter_0, fifo_wen_0, err_addr_0, err_data_0, cor_data_0, control_0, 
  freq_0, up_down_0, err_inj_num_0, m_data_s2d_1, err_sys_hit_1, err_counter_1, fifo_wen_1, 
  err_addr_1, err_data_1, cor_data_1, control_1, freq_1, up_down_1, err_inj_num_1)
...
/* synthesis syn_force_seq_prim="clk_sg" */;
  input resetn;
  ...
  input clk_sg /* synthesis syn_isclock = 1 */;
